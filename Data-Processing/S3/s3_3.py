...
if __name__ == "__main__":
    config = toml.load("config-sample.toml")
    ...
    orders_schema_avro = open('/home/snehasuman/kafka-stream-ovh-fractal/mqtt/schemas/new.avsc', mode='r').read()
    ...
    orders_agg_write_stream = orders_df2 \
        ...
        .format("parquet") \
        .outputMode("append") \
        .option("checkpointLocation", "s3a://testPythonScript") \
        .option("path","s3a://testPythonScript") \
        .start()
