...
s3_lakefs = boto3.client('s3',
  endpoint_url='http://fractal.ik-europe.eu/',
  aws_access_key_id='',
  aws_secret_access_key='')
s3_ovh = boto3.client('s3',
  endpoint_url='https://s3.gra.cloud.ovh.net',
  aws_access_key_id='',
  aws_secret_access_key='')
s3_ovh_resource = boto3.resource('s3',
  endpoint_url='https://s3.gra.cloud.ovh.net',
  aws_access_key_id='',
  aws_secret_access_key='')  
...
with open('final1.parquet','rb') as f3:  
 s3_lakefs.put_object(Body=f3, Bucket='fractal-uc2', Key='test123/result/final.parquet') 