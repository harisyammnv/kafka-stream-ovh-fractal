...
./ovh-spark-submit --projectid $PROJECTID  --packages $PACKAGES --class $CLASS --driver-cores 1 --driver-memory 4G --executor-cores 1 --executor-memory 4G --num-executors 1 swift://test-timeseries-data/s3.py