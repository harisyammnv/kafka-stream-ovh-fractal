...
if __name__ == "__main__":
    ...
    orders_schema_avro = open(str(file_path)+'/'+"schemas/vehicle_ride_value.avsc", mode='r').read()
    ...
    orders_agg_write_stream = orders_df3 \
        ...
        .option("path","/home/snehasuman/kafka-stream-ovh-fractal/Spark_streaming/pyspark_structured_streaming/part4.3/output") \
        .start()
